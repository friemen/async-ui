(ns async-ui.javafx.binding
  ...
  (:import [javafx.beans.value ChangeListener]
           ...
           [javafx.scene.control Button ListView TableView TextField]
           [javafx.stage Stage]
...
(defmethod setter-fns TableView
  [vc]
  (items-selection-fns vc))
